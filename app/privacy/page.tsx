    ...
    <LegalShell title="privacy policy" updated="21 June 2026">
      ...
      <section>
        ...
        <ul>
          ...
          <li>If you opt into Deep Swamp analysis, each task in a dump, which task became the frog, generation details, and your local timezone/hour/day at assignment and later outcomes are stored together to look for your personal patterns.</li>
